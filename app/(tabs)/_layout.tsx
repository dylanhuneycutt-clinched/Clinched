    ...
    >
      ...
      <Tabs.Screen
        ...
        options={{
          title: 'Schedule',
          tabBarIcon: ({ focused }) => (
            <View style={{ width:18, height:16, borderWidth:1.5, borderColor: focused ? '#C9A84C' : '#444', borderRadius:3, marginTop:4 }}>
              <View style={{ position:'absolute', top:-3, left:3, width:1.5, height:5, backgroundColor: focused ? '#C9A84C' : '#444' }} />
              <View style={{ position:'absolute', top:-3, right:3, width:1.5, height:5, backgroundColor: focused ? '#C9A84C' : '#444' }} />
              <View style={{ position:'absolute', top:3, left:0, right:0, height:1.5, backgroundColor: focused ? '#C9A84C' : '#444' }} />
            </View>
          ),
        }}
      />
